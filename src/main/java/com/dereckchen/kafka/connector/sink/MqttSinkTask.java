...
import com.dereckchen.util.JsonUtil;
import com.dereckchen.util.MQTTUtil;
import com.dereckchen.util.MQTTUtil.MQTTConfig;
    ...
    private void sendMQTT(Collection<SinkRecord> records) {
        records.forEach(record -> {
            try {
                ...
                MqttMessage mqttMessage = new MqttMessage(JsonUtil.marshallToBytes(obj));
                if (mqttClient == null) {
